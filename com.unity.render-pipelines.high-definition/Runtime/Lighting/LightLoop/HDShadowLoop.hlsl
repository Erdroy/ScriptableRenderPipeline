            ...
            if (s_lightIdx >= v_lightIdx)
            {
                    ...
                    s_lightData.shadowDimmer > 0)
                {
                    ...
                    if (distances.x < s_lightData.range &&
                        ...
                        L.y > 0.0)
                    {
                        shadowP = GetPunctualShadowAttenuation(shadowContext, posInput.positionSS, posInput.positionWS, normalWS, s_lightData.shadowIndex, L, distances.x, /*s_lightData.lightType == GPULIGHTTYPE_POINT*/ true, s_lightData.lightType != GPULIGHTTYPE_PROJECTOR_BOX);
